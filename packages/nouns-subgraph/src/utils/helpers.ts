...
export function getOrCreateAccount(id: string, createIfNotFound:boolean = true, save:boolean = true): Account {
...
export function getOrCreateDelegate(id: string, createIfNotFound:boolean = true, save:boolean = true): Delegate {
...
export function getOrCreateVote(id: string, createIfNotFound:boolean = true, save:boolean = false): Vote {
...
export function getOrCreateProposal(id: string, createIfNotFound:boolean = true, save:boolean = false): Proposal {
