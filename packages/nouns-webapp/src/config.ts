...
type SupportedChains = ChainId.Rinkeby | ChainId.Goerli | ChainId.Mainnet | ChainId.Hardhat;
...
export const AIRTABLE = process.env.AIRTABLE;
...
const app: Record<SupportedChains, AppConfig> = {
  ...
  [ChainId.Goerli]: {
    ...
    subgraphApiUri:
      'https://api.thegraph.com/subgraphs/name/leplinus/iris-subgraph-goerli-developer',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Mainnet]: {
...
const externalAddresses: Record<SupportedChains, ExternalContractAddresses> = {
  ...
  [ChainId.Goerli]: {
    lidoToken: '0x56340274fB5a72af1A3C6609061c451De7961Bd4',
  },
  [ChainId.Mainnet]: {
