...
export const getNoun = (nounId: string | EthersBN, seed: INounSeed) => {
  ...
  const name = `Social Noun ${id}`;
  const description = `Social Noun ${id} is a member of the Social Noun DAO`;
  let { parts, background } = getNounData(seed);
