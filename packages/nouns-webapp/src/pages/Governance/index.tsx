...
const GovernancePage = () => {
  ...
  const nounSingular = <Trans>Social Nouns</Trans>;
  const nounPlural = <Trans>Social Nouns</Trans>;
    ...
    <Section fullWidth={false} className={classes.section}>
      <Col lg={10} className={classes.wrapper}>
        ...
        <p className={classes.subheading}>
          <Trans>
          Social Nouns govern <span className={classes.boldText}>Social Nouns DAO</span>.
          Social Nouns can vote on proposals or delegate their vote to a third party. A minimum of{' '}
        ...
        <Row className={classes.treasuryInfoCard}>
          ...
          <Col className={classes.treasuryInfoText}>
            <Trans>
              This treasury exists for <span className={classes.boldText}>Social Nouns DAO</span>{' '}
              participants to allocate resources for the long-term growth and prosperity of the
              Social Nouns project.
            </Trans>
          </Col>
        </Row>
