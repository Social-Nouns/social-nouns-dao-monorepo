...
const nounsProtocolLink = (
  <Link
    text={<Trans>Social Nouns Protocol</Trans>}
      ...
      <Container fluid="lg">
        <Row>
          <Col lg={10} className={classes.headerRow}>
            ...
            <p>
              <Trans>
                The playground was built using the {nounsProtocolLink}. Social Noun's traits are
        ...
        <Row>
          <Col lg={3}>
            <Col lg={12}>
              ...
              >
                <Trans>Generate Social Nouns</Trans>
              </Button>
            </Col>
            <Row>
              {traits &&
